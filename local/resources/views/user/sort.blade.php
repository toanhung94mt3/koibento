...
@section('content')
	...
	<div class="item-menu">
		<div class="container">
			<h2 class="text-uppercase text-center">{{ $category->title }}</h2>
			<div class="row">
				<div class="col-3">
					<div id="sticky">
							...
							<div class="item-top">
								...
								<?php
									...
									foreach($images as $image){
										...
										<div class="add-pay">
											<a href="#" title="thêm vào giỏ hàng" data-toggle="modal" data-target="#modal-like-{{$product->id}}"><i class="far fa-eye"></i></a>
											@if(Auth::check())
